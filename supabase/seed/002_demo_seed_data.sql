...
-- Created: 2026-04-08
-- Run AFTER: 001_core_seed_data.sql
BEGIN;
...
INSERT INTO assets (id, organization_id, site_id, asset_class_id, name, asset_tag, status, criticality_level, manufacturer, model, install_date) VALUES
...
INSERT INTO work_orders (id, organization_id, site_id, asset_id, wo_number, title, description, work_type, priority, status, created_at) VALUES
('00000000-0000-0000-0000-000000000200', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000103', 'WO-2026-001', 'Conveyor Belt Replacement', 'Belt showing signs of wear and tracking issues on Conveyor Alpha', 'corrective', 'high', 'in_progress', NOW() - INTERVAL '3 days'),
('00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000100', 'WO-2026-002', 'Pump Seal Inspection', 'Quarterly preventive maintenance - inspect mechanical seals', 'preventive', 'medium', 'pending', NOW() - INTERVAL '1 day'),
('00000000-0000-0000-0000-000000000202', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000105', 'WO-2026-003', 'Compressor Overhaul', 'Scheduled major overhaul per manufacturer recommendation', 'overhaul', 'high', 'in_progress', NOW() - INTERVAL '7 days'),
('00000000-0000-0000-0000-000000000203', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000102', 'WO-2026-004', 'Motor Vibration Analysis', 'Elevated vibration readings detected - investigate root cause', 'condition_based', 'critical', 'pending', NOW() - INTERVAL '6 hours'),
('00000000-0000-0000-0000-000000000204', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000106', 'WO-2026-005', 'Heat Exchanger Cleaning', 'Routine cleaning and tube bundle inspection', 'preventive', 'low', 'completed', NOW() - INTERVAL '14 days'),
('00000000-0000-0000-0000-000000000205', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000104', 'WO-2026-006', 'Air Filter Replacement', 'Replace inlet air filters on compressor unit 1', 'preventive', 'low', 'completed', NOW() - INTERVAL '21 days')
ON CONFLICT DO NOTHING;
